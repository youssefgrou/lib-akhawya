...
if (isset($_GET['updateid'])) {
    $id = $_GET['updateid'];
    $req = "SELECT * FROM student_ext where id ='$id'";
    $st = $db->prepare($req);
    $st->execute();
...
if(isset($_POST['subb']))
{
    ...
    $sql="UPDATE student_ext SET name='$name', phone='$phone',cin='$cin', 
...
<section>
    <nav class="nav">
            <div class="menu">
                <a href="student-extern.php">HOME</a>
 ...
 <form action="" method="POST">
    ...
    <div class=" d-flex justify-content-end">
        <div class="modal-footer">
            <a  href="student-extern.php" type="submit" class="pt-1 pb-2 btn btn-secondary rounded-0 me-3" >Close</a>
